...
# Fit ARIMA model
model = ARIMA(train['DECK'], order=(p, d, q))
fit_model = model.fit()
...
train_mape = mean_absolute_percentage_error(train['DECK'], train['arima_forecast'])
...
test_mape = mean_absolute_percentage_error(test['DECK'], test['arima_forecast'])
